...
class Bio extends React.Component {
  ...
  renderThumbnail() {
    ...
    return <div className="thumbnail mx-auto" style={style} />;
  }
  ...
  renderEditLink() {
    ...
    return (
      <div className="my-3 mt-sm-4 mb-md-0">
        <Link to="/myprofile">Edit your profile</Link>
      </div>
    );
  }
  ...
  renderMeta(type, text, link) {
    ...
    return (
      <div
        className={`meta-with-icon d-flex align-items-center ${
          type == "website" ? "website mt-3" : type
        } x-small`}
      >
        {meta}
      </div>
  ...
  renderOtherMeta() {
    ...
    let location = this.props.location
      ? this.renderMeta(`location`, this.props.location)
      : null;
    let language = this.props.language
      ? this.renderMeta(`language`, this.props.language.join(` ,`))
      : null;
    let story = this.props.storyLink
      ? this.renderMeta(`story`, `Read Story`, this.props.storyLink)
      : null;
    let website = this.props.website
      ? this.renderMeta(`website`, this.props.website, this.props.website)
      : null;
  ...
  renderTags(label = ``, type = ``, tags = []) {
    ...
    tags = tags.map((tag, i) => {
      let link = `/${type}/${
        type === `issues`
          ? Utility.getUriPathFromIssueName(tag)
          : encodeURIComponent(tag)
      }`;

      return (
        <div className="d-inline-block" key={tag}>
    ...
    return (
      <div className="body-small tags mb-1">
          ...
          <div className="col-sm-8 col-md-10">
            <div className="d-flex flex-column flex-sm-row align-items-center align-items-sm-baseline align-items-md-baseline mb-4 mb-sm-3">
              <div className="d-flex flex-column flex-md-row align-items-center align-items-sm-start align-items-md-baseline">
                <h1 className="h5-heading mr-sm-4 text-truncate mw-100 mb-4 mb-sm-1 mb-md-0">
